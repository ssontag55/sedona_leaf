...
(function (e, t) {
    ...
    n.Mixin = {}, n.Mixin.Events = {
        ...
        enableTextSelection: function () {
            this._onselectstart && (document.onselectstart = this._onselectstart, this._onselectstart = null)
        },
        ...
        getScaleString: function (e, t) {
            var r = n.DomUtil.getTranslateString(t),
                i = " scale(" + e + ") ",
                s = n.DomUtil.getTranslateString(t.multiplyBy(-1));
            return r + i + s
        },
        ...
        getBounds: function () {
            var e = this._map,
                t = this._radius * Math.cos(Math.PI / 4),
                r = e.project(this._latlng),
                i = new n.Point(r.x - t, r.y + t),
                s = new n.Point(r.x + t, r.y - t),
                o = e.unproject(i),
                u = e.unproject(s);
        ...
        _getLngRadius: function () {
            var e = 40075017,
                t = e * Math.cos(n.LatLng.DEG_TO_RAD * this._latlng.lat);
        ...
        _onDown: function (e) {
            ...
            this._startPoint = new n.Point(t.clientX, t.clientY), n.DomEvent.on(document, n.Draggable.MOVE, this._onMove, this), n.DomEvent.on(document, n.Draggable.END, this._onUp, this)
        },
        _onMove: function (e) {
        ...
        _onWheelScroll: function (e) {
            ...
            clearTimeout(this._timer), this._timer = setTimeout(n.Util.bind(this._performZoom, this), r), n.DomEvent.preventDefault(e)
        },
        ...
        _onTouchStart: function (e) {
            ...
            this._startCenter = r._add(i)._divideBy(2), this._startDist = r.distanceTo(i), this._moved = !1, this._zooming = !0, this._centerOffset = s.subtract(this._startCenter), t._panAnim && t._panAnim.stop(), n.DomEvent.on(document, "touchmove", this._onTouchMove, this).on(document, "touchend", this._onTouchEnd, this), n.DomEvent.preventDefault(e)
        },
        ...
        _createButton: function (e, t, r, i, s) {
            ...
            return o.href = "#", o.title = e, n.DomEvent.on(o, "click", n.DomEvent.preventDefault).on(o, "click", i, s), n.DomEvent.disableClickPropagation(o), o
        }
    }), n.Map.mergeOptions({
        zoomControl: !0
        ...
        options: {
            ...
            prefix: '<a href="http://otesports.com/locations/sedona/" target="_blank">ote Sports</a>'
        },
        initialize: function (e) {
        ...
        _runAnimation: function (t, r, i, s, o) {
            this._animateToCenter = t, this._animateToZoom = r, this._animatingZoom = !0, n.Draggable && (n.Draggable._disabled = !0);
            var u = n.DomUtil.TRANSFORM,
                a = this._tileBg;
            clearTimeout(this._clearTileBgTimer);
            if (n.Browser.gecko || e.opera) a.style[u] += " translate(0,0)";
            n.Util.falseFn(a.offsetWidth);
            var f = n.DomUtil.getScaleString(i, s),
                l = a.style[u];
            a.style[u] = o ? l + " " + f : f + " " + l
        },
